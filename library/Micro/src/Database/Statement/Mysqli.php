...
namespace Micro\Database\Statement;

use Micro\Database\Statement;
...
class Mysqli extends Statement
{
     ...
     * @param  string $sql
     * @return void
     * @throws \Micro\Database\Statement\Mysqli\Exception
     */
    public function _prepare($sql)
    {
        ...
        if ($this->_stmt === false || $mysqli->errno) {
            throw new Mysqli\Exception("Mysqli prepare error: " . $mysqli->error, $mysqli->errno);
        }
    }
    ...
    public function _execute(array $params = null)
    {
        ...
        if ($retval === false) {
            throw new Mysqli\Exception("Mysqli statement execute error : " . $this->_stmt->error, $this->_stmt->errno);
        }
        ...
        if ($this->_meta === null) {
            ...
            if ($this->_stmt->errno) {
                throw new Mysqli\Exception("Mysqli statement metadata error: " . $this->_stmt->error, $this->_stmt->errno);
            }
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            case Database::FETCH_BOUND:
                ...
                break;
            default:
                throw new Mysqli\Exception("Invalid fetch mode '$style' specified");
                break;
        }
        return $row;
    }
    ...
    {
        throw new Mysqli\Exception(__FUNCTION__.'() is not implemented');
    }
