...
{
    /**
     * Use the PROFILER constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    const PROFILER = 'profiler';

    /**
     * Use the CASE_FOLDING constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    const CASE_FOLDING = 'caseFolding';

    /**
     * Use the FETCH_MODE constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    const FETCH_MODE = 'fetchMode';

    /**
     * Use the AUTO_QUOTE_IDENTIFIERS constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    const AUTO_QUOTE_IDENTIFIERS = 'autoQuoteIdentifiers';

    /**
     * Use the ALLOW_SERIALIZATION constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    const ALLOW_SERIALIZATION = 'allowSerialization';

    /**
     * Use the AUTO_RECONNECT_ON_UNSERIALIZE constant in the config of a \Micro\Database\Adapter\AdapterAbstract.
     */
    ...
    public static function factory($adapter, array $config = array())
    {
         ...
         */
        $adapterNamespace = 'Micro\Database\Adapter';
         ...
         */
        if (!$dbAdapter instanceof Adapter\AdapterAbstract) {
            throw new Exception("Adapter class '$adapterName' does not extend Micro\\Database\\Adapter\\AdapterAbstract");
        }
