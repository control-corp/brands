...
class Query
{
    ...
    /**
     * One of the \Micro\Database\Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the \Micro\Database\Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the \Micro\Database\Profiler::* constants)
     *
     * @return integer
     */
