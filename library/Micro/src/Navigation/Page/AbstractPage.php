...
use Traversable;
use Micro\Navigation\AbstractContainer;
...
abstract class AbstractPage extends AbstractContainer
{
     ...
     * Parent container
     *
     * @var \Micro\Navigation\AbstractContainer|null
     */
    protected $parent;
    ...
    /**
     * Factory for \Micro\Navigation\Page classes
     *
     * @param  array|Traversable $options  options used for creating page
     * @return AbstractPage  a page instance
     * @throws \InvalidArgumentException if $options is not
     *                                            array/Traversable
     * @throws \InvalidArgumentException if 'type' is specified
     *                                            but class not found
     * @throws \InvalidArgumentException if something goes wrong
     *                                            during instantiation of
     *                                            the page
     * @throws \InvalidArgumentException if 'type' is given, and
     *                                            the specified type does
     *                                            not extend this class
     * @throws \InvalidArgumentException if unable to determine
     ...
     *                           forward links to other pages
     * @throws \InvalidArgumentException if $relations is not an array
    ...
    public function setResource($resource = null)
    {
        if (null === $resource
            ...
            throw new \InvalidArgumentException(
                ...
                'or an instance of Micro\Permissions\Acl\Resource\ResourceInterface'
            );
        }
